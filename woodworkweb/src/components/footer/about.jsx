    ...
    <>
      <Wrapper>
        ...
        <P ref={ref}
          ...
          Hello! My name is Geneviève, but most people call me Gen ! I am excited to share a bit about myself
          with you. As I studied in winery and transport logistic in college, I knew there was something more in life that I wanted to do.
        ...
        <P  ref={ref}
          ...
          exploration. As I entered the workforce, I quickly realized that my true passion
          lay elsewhere, specifically where I could build and create. The endless design and creation possibilities truly brings me joy.
        </P>
        ...
        <P ref={ref}
          ...
          animate={inView ? "visible" : "hidden"}
          variants={paragraphVariants}>
          I approach every project with enthusiasm and I'm always willing
          to go the extra mile to ensure the best possible results, just for you. Thank you
